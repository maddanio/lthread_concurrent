...
static void _lthread_cond_acquire(struct lthread_cond *c, lthread_t* self);
static void _lthread_cond_release(struct lthread_cond *c, lthread_t* self);
